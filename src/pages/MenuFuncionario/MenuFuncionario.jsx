        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto">
            <li className="nav-item active">
              <a className= {`navbar-link ${styles.itemMenu}`} href="/pizzaria/funcionario/produtos">
                Produtos
              </a>
            </li>
            <li className="nav-item">
              <a className= {`navbar-link ${styles.itemMenu}`} href="/pizzaria/funcionario/categorias">
                Categorias
              </a>
            </li>
            <li className="nav-item">
              <a className= {`navbar-link ${styles.itemMenu}`} href="/pizzaria/funcionario/estoques">
                Estoque
              </a>
            </li>
